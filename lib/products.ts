// TODO: Replace this with real product data scraped from partner stores via a backend.
// Suggested approach: Vercel Cron job hits Chewy / PetSmart / Amazon affiliate APIs
// daily and writes to Vercel Postgres or Supabase. The frontend then reads from
// /api/products instead of this hardcoded array.
